...
Sprint 5 Planning Date/Time: 10-20 to 11-02
...
|--------|------------------------|--------------|--------------|------------|--------------|--------------|
| RC-001 | As a Scrum Team, we want to identify the Sprint 5 Scrum Master and Product Owner so that I can ensure team responsibilities are clearly defined for the sprint, | 10 | 0 | Y | Done | Full Team |
 | RC-004 | As a customer I want to see a introduction page on the deleoper thats working on this product (about page) - Glaycon | 10 | 2 | N | Done | Glaycon |
 | RC-005 | As a customer I want to see a introduction page on the deleoper thats working on this product (about page) - Andrew | 10 | 2 | N | Done | Andrew |
 | RC-006 | As a customer I want to see a introduction page on the deleoper thats working on this product (about page) - Edgar | 10 | 2 | N | Done | Edgar |
 | RC-007 | As a customer I want to see a introduction page on the deleoper thats working on this product (about page) - Tom | 10 | 2 | N | Ready | Tom |
 | RC-008 | As a customer I want to see a introduction page on the deleoper thats working on this product (about page) - Alan | 10 | 2 | N | Ready | Alan |
 ...
 | RC-009 | As a user I want to make a sketch of how the site will look like and influnce the direction of the product | 5 | 4 | N | Ready | Tom |
