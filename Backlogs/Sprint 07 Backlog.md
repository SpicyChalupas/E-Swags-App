...
| PTG-139 | As a developer, I want to fix and improve the bottom section of the home page so that the layout is consistent, properly aligned, and visually clean across different screen sizes. | 8 | 4 | N | Done | Tom |
