...
| PTG-134 | As a developer, I want the header styling in "main.css". Fix the login and logout button to match the other nav buttons. | 3 | 2 | N | Ready | Tom |
...
| PTG-137 | As a user, I want the website to have a dark mode  | 3 | 6 | N | Ready | Diego |
| PTG-138 | As a developer, I want to populate the Previous Winners section with mock/demo data and create a layout. | 6 | 4 | N | Ready | Tom |
| PTG-139 | As a developer, I want to fix and improve the bottom section of the home page so that the layout is consistent, properly aligned, and visually clean across different screen sizes. | 8 | 4 | N | Ready | Tom |
...
| PTG-141 | As a team member, I want to curate my section of the google slides. | 8 | 4 | Y | Ready | Tom |
...
| PTG-145 | As a team member, I want to curate my section of the google slides. | 8 | 4 | Y | Ready | Edgar |
| PTG-146 | As the Product Owner, I want to video record and document every feature and functionality of the product as reference for future teams. I want to conceptualize the product as an easy-to-digest idea. | 7 | 5 | N | Ready | Diego |
| PTG-147 | As the Scrum Master, I want to video record and document every feature and functionality of the product as reference for future teams. I want to conceptualize the product as an easy-to-digest idea. | 7 | 5 | N | Ready | Andrew |
