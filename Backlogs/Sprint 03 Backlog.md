...
Sprint 3 Planning Date/Time: 2/16 - 3/01
...
|--------|------------------------|--------------|--------------|------------|--------------|--------------|
| RC-088 | As a Dev I want spend time as a team to discuss the projects new direction | 10 | 2 | Y | Done | Everyone |
| RC-085 | As a Dev, I want to make a marketable poster for our product | 8 | 5 | Y | Done | Diego | 
| RC-087 | As a Customer I want a way to submit for help if I forgot my account password or login | 8 | 5 | N | Done | Edgar |  
| RC-070 | As a Dev, I want to add a discription of why im giving credits to a user | 8 | 3 | N | done | Glaycon |
...
| RC-081 | As a Dev, I want to code the backend to allow discription for credits | 6 | 3 | N | Done | Glaycon | 
...
| RC-094 | As a Dev, I want to update the employee credit history page CSS and HTML | 3 | 3 | Y | Done | Diego |
