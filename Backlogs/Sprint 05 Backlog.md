...
| PTG-098 | As a user, I want the background color for every webpage to be a lighter pink instead of dark red. | 6 | # | N | Ready | Tom |
| PTG-099 | As a developer, I want the color of the top-nav buttons when hovered over to fade from black -> white. | 6 | # | N | Ready | Glaycon |
| PTG-100 | As a developer, I want the color of the top-nav buttons TEXT when hovered over to fade from white -> red. | 6 | # | N | Ready | Glaycon |
| PTG-109 | As a developer, I want the "hovered over button" fade effect to be applied to the footer buttons as well. | 6 | # | N | Ready | Tom |
...
| PTG-106 | As a developer, I want to add "Feedback Surveys" to the top-nav bar on all pages. | # | 4 | N | Ready | Diego |
