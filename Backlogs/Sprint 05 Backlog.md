...
| PTG-099 | As a developer, I want the color of the top-nav buttons when hovered over to fade from black -> white. | 6 | 3 | N | Done | Glaycon |
| PTG-100 | As a developer, I want the color of the top-nav buttons TEXT when hovered over to fade from white -> red. | 6 | 3 | N | Done | Glaycon |
...
| PTG-107 | As a developer, I want the top-nav and footer to be consistent across all pages. The top-nav should be ordered: 'Home' 'About' 'Feedback Surveys' 'Raffle' 'Previous Winners' and the footer should be ordered: 'Home' 'About' 'Contact' | 7 | 6 | N | Done | Glaycon |
